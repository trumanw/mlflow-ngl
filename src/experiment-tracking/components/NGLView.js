...
import ShowNGLPage, { getSrc } from './artifact-nglview-components/ShowNGLPage';
import {
  ModelVersionStatus,
...
export class NGLViewImpl extends Component {
  static propTypes = {
  ...
  render() {
    ...
    return (
      <div>
        <div className='ngl-view'>
          <div className='ngl-left'>
            <Treebeard
          ...
          <div className='ngl-right'>
            {/* {this.state.activeNodeId ? this.renderArtifactInfo() : null} */}
            <ShowNGLPage runUuid={this.props.runUuid} path={this.state.activeNodeId} />
          </div>
        </div>
      </div>
    );
...
export const NGLView = connect(mapStateToProps, mapDispatchToProps)(NGLViewImpl);
